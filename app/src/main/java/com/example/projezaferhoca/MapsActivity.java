...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // final String takeunm = getIntent().getExtras().getString("takeun","defaultKey"); //gelen veriyi alır
       // user=takeunm; user a atar
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng konumm = new LatLng(lgsol, lgsag);
        mMap.addMarker(new MarkerOptions().position(konumm).title("Konumunuz"));
        mMap.setMyLocationEnabled(true);
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(konumm,15));
